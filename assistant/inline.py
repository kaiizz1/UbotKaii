...
≽ <b>Pʏ-kaii Vᴇʀsɪᴏɴ :</b> <code>{__version__}</code>
≽ <b>kaii Vᴇʀsɪᴏɴ :</b> <code>{ayiin_ver}</code> [{HOSTED_ON}]
╰✠╼━━━━━━━━━━━━━━━✠╯
    '''
    return output
